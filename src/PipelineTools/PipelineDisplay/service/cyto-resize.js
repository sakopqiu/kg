        ...
        cytoscape('core', 'nodeResize', function (opts) {
            ...
            var BoundingRectangle = function (node) {
                ...
                var rect = new Konva.Rect({
                    ...
                    width: width,
                    height: height,
                    stroke: options.boundingRectangleLineColor(node),
                    strokeWidth: options.boundingRectangleLineWidth(node),
            ...
            Grapple.prototype.bindActiveEvents = function () {
                ...
                var eMouseDown = function (event) {
                    ...
                    const opacity = cy.style()._private.coreStyle["active-bg-opacity"] || {value: 0};
                    tmpActiveBgOpacity = opacity.value;
                    cy.style()
                        .selector("core")
